...
namespace ClassicalCipherToolbox
{
    internal sealed class HelpForm : Form
    {
        ...
        {
            Text = "密码箱 1.2.3 · 文档"; StartPosition = FormStartPosition.CenterParent; FormBorderStyle = FormBorderStyle.Sizable; MaximizeBox = true; MinimizeBox = false; ShowInTaskbar = false;
